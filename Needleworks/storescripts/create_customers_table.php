<?php
//This script is run once in order to create our table of customers in the database. 
...
if(mysql_query($sqlCommand))
{
    ...
    echo"Your customers table has been created successfully!";
} else
{
    //Otherwise, return this error message
    echo"CRITICAL ERROR: customers table has not been created.";
}
?>
