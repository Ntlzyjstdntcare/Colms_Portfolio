...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div style="position:relative; top: 230px;"><p style="font-size:20px;">What is your name?</p></div>
		<div style="position:relative; top: 270px; left: 120px;">
		    <form action="enter_username.php" method="POST">
		    <textarea name="name" rows="1" cols="100"></textarea>
			<br/>
		    <br/>
		    <br/>
			<input type="submit" value="Register" style="position:relative; left: 500px; font-size:30px;"/>
			<br/>
		    <br/>
		    <br/>
			</form>
